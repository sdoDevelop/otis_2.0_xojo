#tag Window
Begin WindowMenuWindow winAbout
   BackColor       =   &cFFFFFF00
   Backdrop        =   0
   CloseButton     =   True
   Compatibility   =   ""
...
#tag Events lblCopyright
	#tag Event
		Sub Open()
		  dim dt as new Date
		  dim sYear as string = str(dt.Year)
		  me.Text = me.Text.ReplaceAll("2013",sYear)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events cvLogo
