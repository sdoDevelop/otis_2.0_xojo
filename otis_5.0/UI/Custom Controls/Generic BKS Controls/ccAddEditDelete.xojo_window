#tag Window
Begin ContainerControl ccAddEditDelete
   AcceptFocus     =   False
   AcceptTabs      =   True
   AutoDeactivate  =   True
   BackColor       =   &cFFFFFF00
...
#tag WindowCode
	#tag Method, Flags = &h0
		Sub AddEnabled(bValue as Boolean)
		  btnAdd.Enabled = bValue
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h0
		Sub DeleteEnabled(bValue as Boolean)
		  btnDelete.Enabled = bValue
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h0
		Sub EditEnabled(bValue as Boolean)
