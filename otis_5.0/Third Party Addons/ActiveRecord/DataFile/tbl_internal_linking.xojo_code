...
Inherits DataFile.ActiveRecordBase
	...
	#tag Method, Flags = &h0
		Shared Function FindByID(id as Integer) As DataFile.tbl_internal_linking
		  //Usage:
		  //dim tbl_internal_linking as DataFile.tbl_internal_linking = DataFile.tbl_internal_linking.FindByID( id )
		  dim s as string
		  s = "Select * from tbl_internal_linking WHERE pkid = " + str(id)
	...
	#tag Property, Flags = &h0
		ifk_child As Integer
	#tag EndProperty

	#tag Property, Flags = &h0
		ifk_parent As Integer
	#tag EndProperty
