#tag Class
Protected Class tbl_events_link
Inherits DataFile.ActiveRecordBase
	#tag Method, Flags = &h0
		Shared Function BaseSQL(bAsCount as Boolean = false) As String
		  ...
		  ars.Append "From tbl_events_link"
	...
	#tag Method, Flags = &h0
		Shared Function FindByID(id as Integer) As DataFile.tbl_events_link
		  //Usage:
		  //dim tbl_events_link as DataFile.tbl_events_link = DataFile.tbl_events_link.FindByID( id )
		  dim s as string
		  s = "Select * from tbl_events_link WHERE pkid = " + str(id)
		  ...
		  dim tbl_events_link as new DataFile.tbl_events_link
		  tbl_events_link.ReadRecord(rs)
	...
	#tag Method, Flags = &h0
		Shared Function List(stmt as PreparedSQLStatement) As DataFile.tbl_events_link()
		  ...
		  dim aro() as DataFile.tbl_events_link
		  ...
		  while rs.eof = false
		    dim oRecord as new DataFile.tbl_events_link
	...
	#tag Method, Flags = &h0
		Shared Function List(sCriteria as string = "", sOrder as string = "", iOffset as Integer = -1) As DataFile.tbl_events_link()
		  ...
		  ars.append DataFile.tbl_events_link.BaseSQL
	...
	#tag Method, Flags = &h0
		Shared Function ListCount(sCriteria as string = "") As Integer
		  ...
		  ars.append DataFile.tbl_events_link.BaseSQL(True)
		  if sCriteria<>"" then
		    ars.append "WHERE " + sCriteria
		  end if
		  dim s as string = ars.JoinSQL
	...
	#tag Property, Flags = &h0
		ifkevents_child As Int64
	#tag EndProperty

	#tag Property, Flags = &h0
		ifkevents_parent As Int64
	#tag EndProperty
	...
	#tag ViewBehavior
		...
		#tag EndViewProperty
		#tag ViewProperty
			Name="ifkevents_child"
			Group="Behavior"
			Type="Integer"
		#tag EndViewProperty
		#tag ViewProperty
			Name="ifkevents_parent"
			Group="Behavior"
			Type="Integer"
		#tag EndViewProperty
		#tag ViewProperty
