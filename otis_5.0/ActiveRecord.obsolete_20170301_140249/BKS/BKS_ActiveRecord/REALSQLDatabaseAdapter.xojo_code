#tag Class
Protected Class REALSQLDatabaseAdapter
Inherits BKS_ActiveRecord.DatabaseAdapter
	#tag Method, Flags = &h0
		Sub BeginTransaction()
		  if m_iTransactionCt=0 and not m_db.AutoCommit then
		    try
	...
	#tag Method, Flags = &h0
		Sub Constructor(oDb as Object)
		    ...
		    dim db as REALSQLDatabase = REALSQLDatabase(oDb)
		    if db=nil then
	...
	#tag Property, Flags = &h21
		Private m_db As REALSQLDatabase
	#tag EndProperty
