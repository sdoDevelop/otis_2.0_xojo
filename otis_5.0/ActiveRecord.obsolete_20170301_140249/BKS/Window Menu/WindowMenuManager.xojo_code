...
Protected Module WindowMenuManager
	...
	#tag Method, Flags = &h1
		Protected Sub Minimize(pWindow as Window)
		    ...
		    Declare Function IsWindowCollapsable Lib Carbon (w as WindowPtr) as Boolean
		    Declare Function CollapseWindow Lib Carbon (w as WindowPtr, b as Boolean) as Integer
		    
		    If IsWindowCollapsable(pWindow) then Call CollapseWindow(pWindow, true)
		  #elseif TargetWin32 then
		    
		    Declare Function ShowWindow Lib "user32.dll" (wnd As Integer, nCmdShow As Integer) As Integer
		    Call ShowWindow(pWindow.WinHWND, 6)
